# OLD DATA CREATION SCRIPT: EPIC Gene Clusters (3, 200)
# UNKNOWN (maybe Lissette Gomez?)
# UNKNOWN DATE

# This script makes versions of the data sets "data/EPIC_Gene_3_200.rds" and
#   "data/EPIC_CpGstoGene_min3CpGs.rds", but the EPIC_Gene_3_200.rds data set
#   doesn't match exactly (it's pretty close though). 
...
annot_df <- IlluminaHumanMethylationEPICanno.ilm10b2.hg19::Other

cpgGene_df <- subset(annot_df, select = "UCSC_RefGene_Name")
